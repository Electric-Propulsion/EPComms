# Copy + Pasted from https://digilent.com/reference/test-and-measurement/guides/waveforms-sdk-getting-started
# "Using the Oscilloscope and the Waveform Generator" section
